...
Чтобы все спасрить уложится в 24 часа, с учетом ограничения в 100 запросов в минуту для IP адреса, я распараллелил
...
Если будет время, перепишу на использование Messenger.
...
1. Запускаем `php bin/console post:get-list` - начнется процесс сбора всех постов.
